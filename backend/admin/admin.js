...
(function() {
  ...
  async function loadReservations() {
    ...
    try {
      ...
      loadingMessage.textContent = 'Error loading reservations';
    }
  }
      ...
      row.innerHTML = `
        ...
        <td>
          <div class="table-actions">
            <button class="btn-icon view-btn" data-id="${reservation.id}" title="View/Edit">✏️</button>
            <button class="btn-icon delete delete-btn" data-id="${reservation.id}" title="Delete">🗑️</button>
          </div>
        </td>
      `;
  ...
  function populateModal(reservation) {
    ...
    document.getElementById('edit-code').textContent = reservation.code;
